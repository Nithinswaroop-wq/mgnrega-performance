package com.example.Mgnrega.Entities;
...
public class Recordsentity {
    ...
    // ✅ PreUpdate - Update timestamp when entity is modified
    @PreUpdate
    ...
    public Double getApprovedLabourBudget() {
        return approvedLabourBudget;
    }

    public void setApprovedLabourBudget(Double approvedLabourBudget) {
        this.approvedLabourBudget = approvedLabourBudget;
    }

    public Double getAverageWageRatePerDayPerPerson() {
        return averageWageRatePerDayPerPerson;
    }

    public void setAverageWageRatePerDayPerPerson(Double averageWageRatePerDayPerPerson) {
        this.averageWageRatePerDayPerPerson = averageWageRatePerDayPerPerson;
    }

    public Double getAverageDaysOfEmploymentProvidedPerHousehold() {
        return averageDaysOfEmploymentProvidedPerHousehold;
    }

    public void setAverageDaysOfEmploymentProvidedPerHousehold(Double averageDaysOfEmploymentProvidedPerHousehold) {
        this.averageDaysOfEmploymentProvidedPerHousehold = averageDaysOfEmploymentProvidedPerHousehold;
    }

    public Double getDifferentlyAbledPersonsWorked() {
        return differentlyAbledPersonsWorked;
    }

    public void setDifferentlyAbledPersonsWorked(Double differentlyAbledPersonsWorked) {
        this.differentlyAbledPersonsWorked = differentlyAbledPersonsWorked;
    }

    public Double getMaterialAndSkilledWages() {
        return materialAndSkilledWages;
    }

    public void setMaterialAndSkilledWages(Double materialAndSkilledWages) {
        this.materialAndSkilledWages = materialAndSkilledWages;
    }

    public Double getNumberOfCompletedWorks() {
        return numberOfCompletedWorks;
    }

    public void setNumberOfCompletedWorks(Double numberOfCompletedWorks) {
        this.numberOfCompletedWorks = numberOfCompletedWorks;
    }

    public Double getNumberOfGPsWithNilExp() {
        return numberOfGPsWithNilExp;
    }

    public void setNumberOfGPsWithNilExp(Double numberOfGPsWithNilExp) {
        this.numberOfGPsWithNilExp = numberOfGPsWithNilExp;
    }

    public Double getNumberOfOngoingWorks() {
        return numberOfOngoingWorks;
    }

    public void setNumberOfOngoingWorks(Double numberOfOngoingWorks) {
        this.numberOfOngoingWorks = numberOfOngoingWorks;
    }

    public Double getPersondaysOfCentralLiabilitySoFar() {
        return persondaysOfCentralLiabilitySoFar;
    }

    public void setPersondaysOfCentralLiabilitySoFar(Double persondaysOfCentralLiabilitySoFar) {
        this.persondaysOfCentralLiabilitySoFar = persondaysOfCentralLiabilitySoFar;
    }

    public Double getScPersondays() {
        return scPersondays;
    }

    public void setScPersondays(Double scPersondays) {
        this.scPersondays = scPersondays;
    }

    public Double getScWorkersAgainstActiveWorkers() {
        return scWorkersAgainstActiveWorkers;
    }

    public void setScWorkersAgainstActiveWorkers(Double scWorkersAgainstActiveWorkers) {
        this.scWorkersAgainstActiveWorkers = scWorkersAgainstActiveWorkers;
    }

    public Double getStPersondays() {
        return stPersondays;
    }

    public void setStPersondays(Double stPersondays) {
        this.stPersondays = stPersondays;
    }

    public Double getStWorkersAgainstActiveWorkers() {
        return stWorkersAgainstActiveWorkers;
    }

    public void setStWorkersAgainstActiveWorkers(Double stWorkersAgainstActiveWorkers) {
        this.stWorkersAgainstActiveWorkers = stWorkersAgainstActiveWorkers;
    }

    public Double getTotalAdmExpenditure() {
        return totalAdmExpenditure;
    }

    public void setTotalAdmExpenditure(Double totalAdmExpenditure) {
    ...
    public Double getTotalHouseholdsWorked() {
        return totalHouseholdsWorked;
    }

    public void setTotalHouseholdsWorked(Double totalHouseholdsWorked) {
        this.totalHouseholdsWorked = totalHouseholdsWorked;
    }

    public Double getTotalIndividualsWorked() {
        return totalIndividualsWorked;
    }

    public void setTotalIndividualsWorked(Double totalIndividualsWorked) {
        this.totalIndividualsWorked = totalIndividualsWorked;
    }

    public Double getTotalNoOfActiveJobCards() {
        return totalNoOfActiveJobCards;
    }

    public void setTotalNoOfActiveJobCards(Double totalNoOfActiveJobCards) {
        this.totalNoOfActiveJobCards = totalNoOfActiveJobCards;
    }

    public Double getTotalNoOfActiveWorkers() {
        return totalNoOfActiveWorkers;
    }

    public void setTotalNoOfActiveWorkers(Double totalNoOfActiveWorkers) {
        this.totalNoOfActiveWorkers = totalNoOfActiveWorkers;
    }

    public Double getTotalNoOfHHsCompleted100DaysOfWageEmployment() {
        return totalNoOfHHsCompleted100DaysOfWageEmployment;
    }

    public void setTotalNoOfHHsCompleted100DaysOfWageEmployment(Double totalNoOfHHsCompleted100DaysOfWageEmployment) {
        this.totalNoOfHHsCompleted100DaysOfWageEmployment = totalNoOfHHsCompleted100DaysOfWageEmployment;
    }

    public Double getTotalNoOfJobCardsIssued() {
        return totalNoOfJobCardsIssued;
    }

    public void setTotalNoOfJobCardsIssued(Double totalNoOfJobCardsIssued) {
        this.totalNoOfJobCardsIssued = totalNoOfJobCardsIssued;
    }

    public Double getTotalNoOfWorkers() {
        return totalNoOfWorkers;
    }

    public void setTotalNoOfWorkers(Double totalNoOfWorkers) {
        this.totalNoOfWorkers = totalNoOfWorkers;
    }

    public Double getTotalNoOfWorksTakenup() {
        return totalNoOfWorksTakenup;
    }

    public void setTotalNoOfWorksTakenup(Double totalNoOfWorksTakenup) {
    ...
    public Double getWomenPersondays() {
        return womenPersondays;
    }

    public void setWomenPersondays(Double womenPersondays) {
        this.womenPersondays = womenPersondays;
    }

    public Double getPercentOfCategoryBWorks() {
        return percentOfCategoryBWorks;
    }

    public void setPercentOfCategoryBWorks(Double percentOfCategoryBWorks) {
        this.percentOfCategoryBWorks = percentOfCategoryBWorks;
    }

    public Double getPercentOfExpenditureOnAgricultureAlliedWorks() {
        return percentOfExpenditureOnAgricultureAlliedWorks;
    }

    public void setPercentOfExpenditureOnAgricultureAlliedWorks(Double percentOfExpenditureOnAgricultureAlliedWorks) {
        this.percentOfExpenditureOnAgricultureAlliedWorks = percentOfExpenditureOnAgricultureAlliedWorks;
    }

    public Double getPercentOfNRMExpenditure() {
        return percentOfNRMExpenditure;
    }

    public void setPercentOfNRMExpenditure(Double percentOfNRMExpenditure) {
        this.percentOfNRMExpenditure = percentOfNRMExpenditure;
    }

    public Double getPercentagePaymentsGeneratedWithin15Days() {
        return percentagePaymentsGeneratedWithin15Days;
    }

    public void setPercentagePaymentsGeneratedWithin15Days(Double percentagePaymentsGeneratedWithin15Days) {
